...
export default function Header() {
    ...
    return (
        <motion.div style={{ y }} className=" fixed top-0 left-0 z-0 h-[100vh] w-full px-[30px] pt-[116px] pb-[64px] flex flex-col items-start justify-end md:justify-between bg-[url(/d31.webp)] bg-cover bg-[center_top] gap-[30px] md:gap-0">
